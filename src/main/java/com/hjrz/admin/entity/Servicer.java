...
public class Servicer {
    ...
    public Integer getServerStock() {
        return serverStock;
    }

    public void setServerStock(Integer serverStock) {
        this.serverStock = serverStock;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getServerCode() == null ? other.getServerCode() == null : this.getServerCode().equals(other.getServerCode()))
            ...
            && (this.getServerStock() == null ? other.getServerStock() == null : this.getServerStock().equals(other.getServerStock()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getServerStock() == null) ? 0 : getServerStock().hashCode());
        return result;
    }
}