            ...
            <div class="col-xs-12 col-md-12">
              	...
              	<div class="component">
              		<!-- 内容start -->
	              		...
	              		<form class="form-inline" action="/servicer/queryServerInit.hjrz" method="get">
			              	...
			              	<div style="margin-top: 10px">
				              	...
				              	<input type="button"  class="btn btn-info" onclick="window.location.href='<%=basePath %>worksatation/addWorkStation.hjrz'" value="添加工作站>>>">
			              	</div>
			              </div>
		              	</form>
	              		</div>
              		...
              		<table>
							...
							<tbody>	
							<c:forEach items="${workStationModels}" var="w" begin="0" varStatus="status">
								<tr>
